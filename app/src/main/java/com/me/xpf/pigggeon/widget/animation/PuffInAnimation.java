package com.me.xpf.pigggeon.widget.animation;
...
//                            getListener().onAnimationEnd(PuffInAnimation.this);
     ...
     */
    public android.view.animation.Animation.AnimationListener getListener() {
        return listener;
    }
     ...
     *         chained.
     */
    public PuffInAnimation setListener(android.view.animation.Animation.AnimationListener listener) {
